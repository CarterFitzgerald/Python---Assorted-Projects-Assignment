...
class Fitness_Tracker_GUI:
    def __init__(self):
        self.main_window = tkinter.Tk()
        self.main_window.geometry('750x450+600+300')
        self.main_window.title('Fitness Tracker')
        ...
        self.name_label = tkinter.Label(self.frame1, text='Fitness Tracker Program')
        self.name_label.pack()

        display_button = tkinter.Button(self.button_frame, text='Display', command=self.display_step_stats)
        ...
        self.result_ta = tkinter.Text(self.result_frame, bg='light grey', height=15, width=20, relief=FLAT)
        self.result_ta.pack()
        self.result2_ta = tkinter.Text(self.result2_frame, bg='light grey', height=15, width=20, relief=FLAT)
...
# This is the variable that calls the average function and formats the value to return the correct average steps.
            jan_avg = ("{:,.1f}".format(self.average(jan_lst)))
...
# This is the variable that calls the average function and formats the value to return the correct average steps.
            feb_avg = ("{:,.1f}".format(self.average(feb_lst)))
...
# This is the variable that calls the average function and formats the value to return the correct average steps.
            mar_avg = ("{:,.1f}".format(self.average(mar_lst)))
...
# This is the variable that calls the average function and formats the value to return the correct average steps.
            apr_avg = ("{:,.1f}".format(self.average(apr_lst)))
...
# This is the variable that calls the average function and formats the value to return the correct average steps.
            may_avg = ("{:,.1f}".format(self.average(may_lst)))
...
# This is the variable that calls the average function and formats the value to return the correct average steps.
            jun_avg = ("{:,.1f}".format(self.average(jun_lst)))
# This appends the average steps taken in Feb to a yearly list
...
# This is the variable that calls the average function and formats the value to return the correct average steps.
            jul_avg = ("{:,.1f}".format(self.average(jul_lst)))
...
# This is the variable that calls the average function and formats the value to return the correct average steps.
            aug_avg = ("{:,.1f}".format(self.average(aug_lst)))
...
# This is the variable that calls the average function and formats the value to return the correct average steps.
            sep_avg = ("{:,.1f}".format(self.average(sep_lst)))
# This appends the average steps taken in May to a yearly list
...
# This is the variable that calls the average function and formats the value to return the correct average steps.
            oct_avg = ("{:,.1f}".format(self.average(oct_lst)))
# This appends the average steps taken in Feb to a yearly list
...
# This is the variable that calls the average function and formats the value to return the correct average steps.
            nov_avg = ("{:,.1f}".format(self.average(nov_lst)))
# This appends the average steps taken in Jul to a yearly list
...
# This is the variable that calls the average function and formats the value to return the correct average steps.
            dec_avg = ("{:,.1f}".format(self.average(dec_lst)))
# This appends the average steps taken in Aug to a yearly list
            ...
            self.result_ta.insert('1.0', "Month\n")
            self.result2_ta.insert('1.0', "Average Steps Taken\n")
            for month in month_lst:
                self.result_ta.insert(END, str(month) + '\n')
            for avg in avg_lst:
                self.result2_ta.insert(END, str(avg) + '\n')
